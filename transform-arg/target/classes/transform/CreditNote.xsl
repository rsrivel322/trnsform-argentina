...
<!--
    ...
    XSLT transformación de Notas de Credito en formato UBL 2.1 a UBL 2.0

    título=             CreditNote.xsl  
...
<!-- 	<xsl:template match="cac:CreditNoteLine/cac:Item/cac:SellersItemIdentification"> -->
...
<!-- 	</xsl:template> -->
	...
	<xsl:template match="cac:CreditNoteLine/cac:PricingReference">
<!-- 		<xsl:copy-of select="." /> -->
	...
	<xsl:template match="cac:CreditNoteLine/cac:Item">
		<xsl:variable name="id">
			<xsl:element name="cac:SellersItemIdentification">
